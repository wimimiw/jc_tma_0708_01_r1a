...
static const GPIO_FUNC gpioTable[] = {
    ...
    {GPIOA, GPIO_Pin_9 , 0, GPIO_Mode_Out_PP 	 }, /*3SW2           */ 
    {GPIOA, GPIO_Pin_10, 0, GPIO_Mode_Out_PP	 }, /*3SW1           */
    ...
    {GPIOB, GPIO_Pin_12, 0, GPIO_Mode_Out_PP	 }, /*Attenuator-LE2 */
    {GPIOB, GPIO_Pin_13, 0, GPIO_Mode_Out_PP	 }, /*Attenuator-LE1 */    
    {GPIOB, GPIO_Pin_14, 0, GPIO_Mode_Out_PP	 }, /*NC             */
    {GPIOB, GPIO_Pin_15, 0, GPIO_Mode_Out_PP	 }, /*Attenuator-LE4 */
